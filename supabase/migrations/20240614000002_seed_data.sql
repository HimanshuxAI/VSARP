...
-- This migration inserts demo data for VSARP

-- Insert demo users (using deterministic UUIDs from seedData.js)
...
('00000000-0000-4000-a000-000000000003', 'rohan.deshmukh@vsarp.edu', 'Rohan Deshmukh', 'student', 'EC-2023-003', 'Electronics', 'active', ARRAY['Python', 'IoT', 'Data Structures'], '9876543212'),
('00000000-0000-4000-a000-000000000004', 'sneha.kulkarni@vsarp.edu', 'Sneha Kulkarni', 'student', 'IT-2023-004', 'Information Technology', 'active', ARRAY['React', 'Node.js', 'MongoDB'], '9876543213'),
('00000000-0000-4000-a000-000000000005', 'arjun.mehta@vsarp.edu', 'Arjun Mehta', 'student', 'ME-2023-005', 'Mechanical', 'active', ARRAY['Java', 'Data Structures', 'System Design'], '9876543214'),
...
-- Insert demo placement applications
...
-- Insert demo placement notifications
...
('00000000-0000-4000-a000-000000000106', '00000000-0000-4000-a000-000000000003', 'Rohan Deshmukh', 'EC-2023-003', 'Electronics', 'AI Robotics Simulation Challenge - 2nd Place', 'Hackathon', 'Technical', 'Python', '2025-26', '6', 'Built a Python-based autonomous navigation simulator for agricultural monitoring robots.', 'https://example.com/robo.pdf', 'approved', '2026-02-11T10:00:00Z'),
('00000000-0000-4000-a000-000000000107', '00000000-0000-4000-a000-000000000003', 'Rohan Deshmukh', 'EC-2023-003', 'Electronics', 'IoT Data Pipeline Certification', 'Certification', 'Technical', 'IoT', '2025-26', '5', 'Completed a 40-hour IoT data ingestion and analytics workshop conducted by CDAC Pune.', 'https://example.com/iot.pdf', 'approved', '2025-07-16T10:00:00Z'),
('00000000-0000-4000-a000-000000000108', '00000000-0000-4000-a000-000000000004', 'Sneha Kulkarni', 'IT-2023-004', 'Information Technology', 'Full-Stack Development Internship', 'Internship', 'Technical', 'React', '2025-26', '6', 'Built a customer dashboard using React + Node.js for a Bangalore startup.', 'https://example.com/fs_intern.pdf', 'approved', '2026-01-21T10:00:00Z'),
('00000000-0000-4000-a000-000000000109', '00000000-0000-4000-a000-000000000004', 'Sneha Kulkarni', 'IT-2023-004', 'Information Technology', 'Soft Skills Leadership Workshop', 'Soft Skills Test', 'Leadership', 'Communication', '2025-26', '5', 'Completed TCS iON leadership and communication workshop.', 'https://example.com/soft.pdf', 'approved', '2025-09-11T10:00:00Z'),
('00000000-0000-4000-a000-000000000110', '00000000-0000-4000-a000-000000000005', 'Arjun Mehta', 'ME-2023-005', 'Mechanical', 'Algorithms Club Mentor', 'Leadership', 'Leadership', 'Data Structures', '2025-26', '6', 'Mentored juniors through weekly DSA practice labs and mock coding interviews.', 'https://example.com/dsa_mentor.pdf', 'approved', '2026-03-06T10:00:00Z'),
('00000000-0000-4000-a000-000000000111', '00000000-0000-4000-a000-000000000005', 'Arjun Mehta', 'ME-2023-005', 'Mechanical', 'Microsoft Azure Fundamentals Certification', 'Certification', 'Technical', 'Cloud', '2025-26', '5', 'Achieved Microsoft Azure Fundamentals credential for cloud services and deployment basics.', 'https://example.com/azure.pdf', 'approved', '2025-08-23T10:00:00Z'),
...
('00000000-0000-4000-a000-000000000121', '00000000-0000-4000-a000-000000000004', 'Sneha Kulkarni', 'IT-2023-004', 'Information Technology', 'College Coding Contest Winner', 'Hackathon', 'Technical', 'DSA', '2025-26', '6', 'Won 1st place in intra-college competitive programming contest.', 'https://example.com/cc.pdf', 'pending', '2026-04-02T10:00:00Z'),
('00000000-0000-4000-a000-000000000122', '00000000-0000-4000-a000-000000000003', 'Rohan Deshmukh', 'EC-2023-003', 'Electronics', 'Peer Coding Bootcamp Organizer', 'Leadership', 'Leadership', 'Leadership', '2025-26', '6', 'Organized a peer coding bootcamp for first-year Computer Science students.', 'https://example.com/bootcamp.pdf', 'pending', '2026-03-21T10:00:00Z')
ON CONFLICT (id) DO NOTHING;

-- Insert demo research papers
