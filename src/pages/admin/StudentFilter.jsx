                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full h-10 border border-gray-300 rounded-md px-3 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-black appearance-none"
                        >
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {filtered.map(s => (
                                    <tr
                                        ...
                                        className={`cursor-pointer transition-colors hover:bg-slate-50 ${selected.has(s.id) ? 'bg-blue-50/60' : ''}`}
                                    >
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <span className={`inline-flex items-center justify-center w-12 h-7 rounded-full text-xs font-bold ${SCORE_COLOR(s.score)}`}>
                                                {s.score}
                                            </span>
                                        </td>
