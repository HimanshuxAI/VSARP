...
export const SEED_USERS = [
    ...
    { id: uid(3), email: 'rohan.deshmukh@vsarp.edu', full_name: 'Rohan Deshmukh', role: 'student', student_id: 'EC-2023-003', department: 'Electronics', status: 'active', skills: ['Python', 'IoT', 'Data Structures'], phone: '9876543212' },
    ...
    { id: uid(5), email: 'arjun.mehta@vsarp.edu', full_name: 'Arjun Mehta', role: 'student', student_id: 'ME-2023-005', department: 'Mechanical', status: 'active', skills: ['Java', 'Data Structures', 'System Design'], phone: '9876543214' },
...
export const SEED_ACTIVITIES = [
    ...
    // Arjun's activities
    { id: uid(110), student_id: uid(5), student_name: 'Arjun Mehta', student_reg_no: 'ME-2023-005', department: 'Mechanical', title: 'Algorithms Club Mentor', category: 'Leadership', outcome_type: 'Leadership', skill_tag: 'Data Structures', academic_year: '2025-26', semester: '6', description: 'Mentored juniors through weekly DSA practice labs and mock coding interviews.', date: '2026-03-05', proof_url: 'https://example.com/dsa_mentor.pdf', status: 'approved', submitted_at: '2026-03-06T10:00:00Z' },
    { id: uid(111), student_id: uid(5), student_name: 'Arjun Mehta', student_reg_no: 'ME-2023-005', department: 'Mechanical', title: 'Microsoft Azure Fundamentals Certification', category: 'Certification', certification_tier: 'tier1', outcome_type: 'Technical', skill_tag: 'Cloud', academic_year: '2025-26', semester: '5', description: 'Achieved Microsoft Azure Fundamentals credential for cloud services and deployment basics.', date: '2025-08-22', proof_url: 'https://example.com/azure.pdf', status: 'approved', submitted_at: '2025-08-23T10:00:00Z' },
...
export const DEMO_LOGINS = [
    ...
    { label: 'Rohan (Student)', email: 'rohan.deshmukh@vsarp.edu', role: 'student', dept: 'EC' },
    { label: 'Sneha (Student)', email: 'sneha.kulkarni@vsarp.edu', role: 'student', dept: 'IT' },
    { label: 'Arjun (Student)', email: 'arjun.mehta@vsarp.edu', role: 'student', dept: 'ME' },
